...
bike_raw_raw <- read_csv("01 Input/Bicycle_Thefts_Open_Data.csv")
neighbourhood_data <- read_csv("01 Input/Neighbourhood_Crime_Rates_Open_Data.csv")
# lane <- read_csv("01 Input/cycling-network - 4326.csv")
toronto_neighborhoods <- st_read(file.path("01 Input/toneighshape/Neighbourhoods v2_region.shp"))

shape <- st_read("01 Input/cycling-network - 4326/cycling-network - 4326.shp")
