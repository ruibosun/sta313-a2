...
shape <- st_read("input/cycling-network - 4326/cycling-network - 4326.shp")
...
#| message: false
#| label: fig-map2
#| fig-cap: Bike Thefts Crime Rate in Toronto by Neighborhood
#| fig-width: 8
#| fig-height: 4
...
ggplot(toronto_thefts_rate) +
  ...
  geom_sf(data = shape, color = "darkred", size = 0.5, inherit.aes = FALSE, alpha = 0.4) +
